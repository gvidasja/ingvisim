...
module.exports.make = function(semantics) {
    ...
    var ASTBuilder = semantics.addOperation('toAST', {
        ...
        Or: (a, _, b)  => new AST.BinOp('or', a.toAST(), b.toAST()),
       ...
       // MyArray: (_1, args, _2) => new AST.MyArray(args.toAST()),
        ...
        ArrayLiteral: (_, elements, __) => new AST.ArrayLiteral(elements.asIteration().toAST()),
        // ArrayElement: 
        Number: function (a) {
            return new AST.MNumber(a.calc());
        },
        String: (a, text, b) => new AST.MString(text.sourceString)
    });
